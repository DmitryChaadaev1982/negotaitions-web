export const en = {
  ...
  common: {
    ...
    copyLinkFallbackBody:
      "Clipboard is unavailable. Select and copy the link manually.",
    close: "Close",
  ...
  sessions: {
    ...
    completeSessionDebriefConfirmBody:
      "Complete this Session and close the debrief for all participants?",
    ...
    newParticipantsObserverOrUnassigned: "New participants will be observers or unassigned",
  ...
  admin: {
    ...
    emailJournal: "Email",
    emailJournalTitle: "Email operations",
    emailJournalEmpty: "No email messages match the current filters.",
    emailJournalSearch: "Search by recipient, message ID, provider ID, or idempotency key",
    emailJournalReveal: "Reveal retained content",
    emailJournalRevealed: "Retained content",
    emailJournalContentUnavailable: "Retained content is unavailable.",
    emailJournalContentCleared: "Retained content was cleared by retention policy.",
    emailJournalBackToList: "Back to email journal",
    emailJournalProvider: "Provider",
    emailJournalStatus: "Status",
    emailJournalType: "Type",
    emailJournalLocale: "Locale",
    emailJournalAttempts: "Attempts",
    emailJournalCreated: "Created",
    emailJournalUpdated: "Updated",
    emailJournalLastAttempt: "Last attempt",
    emailJournalNextRetry: "Next retry",
    emailJournalRecipient: "Recipient",
    emailJournalProviderMessageId: "Provider message ID",
    emailJournalSuppressed: "Suppressed",
    emailJournalFailure: "Failure",
    emailJournalTemplateVersion: "Template version",
    emailJournalPrevious: "Previous",
    emailJournalNext: "Next",
    emailJournalPage: "Page",
    emailJournalRedactedNotice:
      "Password-reset secrets in retained content are redacted before display.",
    usageDisclaimer:
    ...
    voximplantWebhookEffectiveUrl: "Effective URL (scenarioMessage.claims.webhookBaseUrl)",
  ...
  recording: {
    ...
    recordingStatusUnknown: "Recording status unavailable",
    ...
    insertManualSpeakerTurnAfter: "Insert after",
  ...
  dashboard: {
    ...
    currentSection: "Continue / Current",
    ...
    futureDashboardArea:
      "Future progress, statistics, calendar, and messages can be added below the current activity lanes without competing with the primary action.",
    ...
    eventTimeDuration: "Time: {time} · Duration: {duration}",
  },
  sessionMaterials: {
    ...
    aiAnalysisPendingTitle: "Full analysis is in progress",
    aiAnalysisPendingDescription:
      "Sections remain pending until the complete report passes validation.",
    aiAnalysisSectionPending: "Pending",
  ...
  room: {
    ...
    readyToStartNegotiation: "Preparation complete",
    ...
    participantsCanPrepare: "Waiting for preparation",
    waitingForPreparation: "Waiting for preparation",
    facilitatorWillStartShortly: "Facilitator will start shortly",
    checkParticipantsAndConnection: "Check participants and connection",
    preparationComplete: "Preparation complete",
    waitingForFacilitator: "Waiting for facilitator",
    waitingForFacilitatorStart: "Waiting for facilitator",
    manualCameraHint:
      "Participants may turn off camera manually during preparation if they want.",
    negotiationInProgress: "Negotiations in progress",
    negotiationPaused: "Negotiations paused",
    negotiationFinishedDebrief: "Negotiation finished — debrief mode",
    oneMinuteRemaining: "1 minute remaining",
    finalTenSeconds: "Final 10 seconds",
    timeIsUp: "Time is up",
    negotiationsComplete: "Negotiations complete",
    debriefIsNext: "Debrief is next",
    discussMeetingResults: "You can discuss the meeting results",
    startPreparation: "Start preparation",
    assignRolesBeforePreparation: "Assign participants to roles first.",
    ...
    observerCountLabel: "Observers · {count}",
    observerRailRegionLabel: "Observer roster, {count} observers",
    observerTileAriaLabel: "{name}. {connection}. {mic}. {camera}.",
    scrollObserversLeft: "Scroll observers left",
    scrollObserversRight: "Scroll observers right",
    ...
    unableToPersistLeave: "Unable to confirm room leave. Please try again.",
    leavePersistenceTimedOut:
      "Leave request timed out. Check connection and try again.",
    ...
    enableSound: "Enable notifications",
    enableSessionSound: "Enable notifications",
    disableSessionSound: "Disable notifications",
    a11yPreparationStarted: "Preparation started.",
    a11yPreparationPaused: "Preparation paused.",
    a11yPreparationResumed: "Preparation resumed.",
    a11yNegotiationStarted: "Negotiations started.",
    a11yNegotiationPaused: "Negotiations paused.",
    a11yNegotiationResumed: "Negotiations resumed.",
    a11yOneMinuteRemaining: "1 minute remaining.",
    a11yTenSecondsRemaining: "Final 10 seconds.",
    a11yTimeExpired: "Time is up. Negotiations complete.",
    a11yManualCompletion: "Negotiations complete. Debrief is next.",
    autoplayBlocked:
  ...
  events: {
    ...
    scheduledAtHint:
      "Required for planning and invitations. Defaults to your current local date and time.",
    timeZone: "Time zone",
    timeZoneHint: "Select the time zone this event is scheduled in.",
    ...
    sessionsBoard: "Session board",
    sessionsInThisEvent: "Sessions in this event",
    mySessionsInThisEvent: "My sessions in this event",
    sessionsWithoutMyParticipation: "Sessions I did not participate in",
    newSession: "New session",
    roomName: "Room name",
    ...
    presenceLegend:
      "Presence: green — online, yellow — recently disconnected, red — offline, gray — invited and never connected.",
    participantLocationLobby: "In lobby",
    participantLocationSession: "In session: {title}",
    finishedSession: "Finished session",
    mySession: "My Session",
    mySessionSubtitle: "Your current assignment and next available action.",
    currentAssignment: "Current assignment",
    noCurrentSessionAssignment: "No Session assignment yet.",
    desiredRole: "Desired role",
    changeDesiredRole: "Change",
    desiredRoleHelp:
      "Choose how you would like to participate. The organizer will use this preference for assignment.",
    desiredRoleSelected: "Desired role: {role}",
    cameraOn: "Camera on",
    ...
    turnOffOwnMicrophone: "Turn microphone off",
    disableParticipantCamera: "Turn participant camera off",
    disableParticipantMicrophone: "Mute participant microphone",
    requestParticipantCamera: "Request camera on",
    requestParticipantMicrophone: "Request microphone on",
    cameraEnableRequested: "Camera enable requested",
    microphoneEnableRequested: "Microphone enable requested",
    mediaEnableRequestBody:
      "{name} is asking you to turn on your {device}. You can enable it or decline the request.",
    cameraDevice: "camera",
    microphoneDevice: "microphone",
    acceptMediaEnableRequest: "Enable",
    declineMediaEnableRequest: "Decline",
    sessionCreationSetup: "Session creation and setup",
    participantAssignment: "Participant assignment",
    eventLevelManagement: "Event-level management",
    completedSessionHistory: "Completed Session history",
    completedSessions: "Completed Sessions",
    openRoom: "Open room",
    returnToDebrief: "Return to debrief",
    openMaterials: "Open materials",
    openResults: "Open results",
    ...
    singleDeviceHint:
      "Your camera or microphone may be unavailable if it is already being used by another tab, browser, or application.",
    copyEventJoinLink: "Copy event join link",
    publicJoinLink: "Public join link",
    hostLink: "Host link",
    eventCompleted: "Event completed",
    eventCompletedTitle: "This event was completed by the organizer.",
    eventCompletedSubtitle: "The event is completed.",
    eventSessionsSectionTitle: "Event sessions",
    sessionMaterialsSectionSubtitle: "Session materials",
    completedSessionStatus: "Completed",
    openMaterialsAction: "Open materials",
    noAccessibleSessionsForCompletedEvent:
      "You do not have any accessible sessions for this event.",
    completeEvent: "Complete event",
    completeEventTitle: "Complete event?",
    eventCompletion: "Event completion",
    completeEntireEvent: "Complete entire event",
    completeEntireEventTitle: "Complete entire event?",
    eventCompletionDangerHint:
      "Completing the event will close its remaining active sessions and move the event to results.",
  ...
  auth: {
    ...
    passwordRequirementMin: "At least {min} characters",
    passwordRequirementMax: "At most {max} characters",
    passwordRequirementMatch: "Passwords match",
    passwordRequirementCommon: "Password is not a common password",
    passwordRequirementReused: "Password has not been used before",
    passwordRequirementMet: "Satisfied",
    passwordRequirementUnmet: "Not yet satisfied",
    passwordRequirementNeutral: "Not checked yet",
  ...
  validation: {
    ...
    scheduledAtRequiredOnUpdate:
      "Scheduled date and time cannot be cleared from an existing event.",
