...
const LIB_RUNTIME_SOURCE_FILES = new Set([
  ...
  "lib/services/transcript-enhancement-retry.ts",
  "lib/services/transcript-enhancement-start-decision.ts",
  ...
  "lib/session-participant-locking.ts",
  ...
  "lib/storage/s3.ts",
  "lib/test-mode.ts",
  "lib/transcription/canonical-diarized-text.ts",
