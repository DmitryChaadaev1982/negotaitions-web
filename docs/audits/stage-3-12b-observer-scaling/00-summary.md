...
- Added observer count, accessible region/tile labels, keyboard scroll support, restrained scroll buttons, and no-wrap layout assertions.
- Added stable client-side camera/connection priority using already available roster/media state.
