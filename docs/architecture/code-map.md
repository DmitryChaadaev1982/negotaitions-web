...
- Engineering workflow and eval registry
  - Code: `scripts/eval-registry-check.mjs`, `scripts/eval-registry-lib.mjs`, `scripts/check-native-dialogs.mjs`, `scripts/check-native-dialogs-lib.mjs`, `scripts/native-dialog-allowlist.json`, `components/confirm-dialog.tsx`, `components/copy-link-fallback-dialog.tsx`, `lib/admin-user-action-dialog.ts`, `package.json` (`eval:registry:check`, `check:native-dialogs`, `test:unit`, `validate:fast`, `validate:build`, `validate:deploy`)
  ...
  - Tests: `scripts/__tests__/eval-registry-check.test.mjs`, `scripts/__tests__/check-native-dialogs.test.mjs`, `scripts/__tests__/validate-gate-scripts.test.mjs`, `components/native-dialog-cleanup.test.ts`
