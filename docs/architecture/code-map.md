...
- Engineering workflow and eval registry
  - Code: `scripts/eval-registry-check.mjs`, `scripts/eval-registry-lib.mjs`, `package.json` (`eval:registry:check`)
  ...
  - Tests: `scripts/__tests__/eval-registry-check.test.mjs`
