...
| Engineering workflow, evals, validation ladder | `docs/testing/engineering-workflow.md`, `docs/testing/validation-checklist.md` | `docs/testing/eval-registry.json` (`npm run eval:registry:check`), `.cursor/skills/validate-wave/SKILL.md`, `docs/testing/agent-model-routing.md` |
